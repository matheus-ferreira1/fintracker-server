...
- Use `vue` skill for Vue/Nuxt best practices
- Use `java-spring` skill for Java/Spring best practices
- Use `bun-node-express` skill for Bun/Node.js/Express best practices
